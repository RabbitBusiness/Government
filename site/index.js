(async () => {
	...
	const proposals = [{
        	...
        	title: ‘End USDC and wBTC pools PROPOSAL’,
...
This will keep holders happy until wVIAT swap end offset potential dumping of the rewards from the other pools, as they can re-stake it in the DAI for a raised APY. Also encourages potential new investors to buy, as they can stake immidiately all of their SNTVT until wVIAT is ready.’
		options: ['YES', 'NO']
